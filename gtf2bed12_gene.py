...
def main():
	...
	parser.add_option('-r', '--reference', type=str, dest='reference', default="transcript", help='use the attribute REFERENCE to group features [default: %default]', metavar='REFERENCE')
	...
	reference_attribute = "%s_id" % reference_feature
	...
	for line in stdin:
		...
		t_id =  attributes.get(reference_attribute,None)
		if t_id is None: 
			if options.ignore:
				continue
